...
// Phase_transition_in_particle_system_Сplus.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPhasetransitionsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPhasetransitionsApp

CPhasetransitionsApp::CPhasetransitionsApp()
{
...
// Единственный объект CPhasetransitionsApp

CPhasetransitionsApp theApp;


// Инициализация CPhasetransitionsApp

BOOL CPhasetransitionsApp::InitInstance()
{
	...
	CPhasetransitioninparticlesystemСplusDlg dlg;
	m_pMainWnd = &dlg;
